...
export default function SettingsPage() {
  ...
  const isLoading =
    preferences.isLoading || accounts.isLoading || cards.isLoading || categories.isLoading;
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Defaults usados ao criar um novo lançamento.
              </p>
            </div>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Field label="Tipo padrão">
              <Select
                ...
                onValueChange={(value) =>
                  setForm((current) => ({ ...current, defaultMovementKind: value as MovementKind }))
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <Field label="Parcelas padrão">
              <Input
                ...
                onChange={(event) =>
                  setForm((current) => ({
                    ...current,
                    defaultInstallmentCount: Number(event.target.value) || 1,
                  }))
                }
              />
            </Field>
            ...
            <Field label="Conta padrão">
              <IdSelect
                ...
                onChange={(value) =>
                  setForm((current) => ({ ...current, defaultAccountId: value }))
                }
              />
            </Field>
            ...
            <Field label="Conta destino">
              <IdSelect
                ...
                items={activeAccounts.map((account) => ({ id: account.id, label: account.name }))}
                onChange={(value) =>
                  setForm((current) => ({ ...current, defaultTargetAccountId: value }))
                }
              />
            </Field>
            ...
            <Field label="Categoria de despesa">
              <IdSelect
                ...
                onChange={(value) =>
                  setForm((current) => ({ ...current, defaultExpenseCategoryId: value }))
                }
              />
            </Field>
            ...
            <Field label="Categoria de receita">
              <IdSelect
                ...
                onChange={(value) =>
                  setForm((current) => ({ ...current, defaultIncomeCategoryId: value }))
                }
              />
            </Field>
          </div>
          ...
          <div className="grid gap-3 md:grid-cols-3">
            <NotificationToggle
              ...
              onCheckedChange={(checked) =>
                updateNotificationPreference(setForm, "connectionRequests", checked)
              }
            />
            <NotificationToggle
              ...
              onCheckedChange={(checked) =>
                updateNotificationPreference(setForm, "sharedExpenses", checked)
              }
            />
            <NotificationToggle
              ...
              onCheckedChange={(checked) =>
                updateNotificationPreference(setForm, "financialDigest", checked)
              }
            />
          </div>
        </CardContent>
